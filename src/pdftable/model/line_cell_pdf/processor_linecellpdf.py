...
from pdftable.model.line_cell_pdf import LineCellPdfConfig
from pdftable.utils.ocr import OcrCommonUtils

__all__ = [
    "LineCellPdfPreProcessor",
    "LineCellPdfPostProcessor"
]


class LineCellPdfPreProcessor(object):

    def __init__(self, config: LineCellPdfConfig):
        super().__init__()
...
class LineCellPdfPostProcessor(object):

    def __init__(self, config: LineCellPdfConfig, output_dir=None, show_info=True):
        super().__init__()
        self.config = config

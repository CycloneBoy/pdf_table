...
# ------------------------------------------------------------------------------
# The implementation is adopted from LORE-TSR,
...
from ..center_net.modeling_centernet import dla34
...
def get_dla_dcn(num_layers, heads, head_conv=256, down_ratio=4, pretrained=False, ):
...
class LoreDla34DetectModel(nn.Module):

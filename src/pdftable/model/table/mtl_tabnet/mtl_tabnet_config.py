from pdftable.model.table.mtl_tabnet.mtl_tabnet_constants import STRUCTURE_ALPHABET_PUBTABNET, \
...
# alphabet_file = './data/alphabet/pubtabnet/structure_alphabet.txt'
# alphabet_len = len(open(alphabet_file, 'r').readlines())
alphabet_file = STRUCTURE_ALPHABET_PUBTABNET
alphabet_len = len(alphabet_file)
max_seq_len = 500

# cell_alphabet_file = './data/alphabet/pubtabnet/textline_recognition_alphabet.txt'
# cell_alphabet_len = len(open(cell_alphabet_file, 'r').readlines())
cell_alphabet_file = TEXTLINE_RECOGNITION_ALPHABET_PUBTABNET
cell_alphabet_len = len(cell_alphabet_file)
max_seq_len_cell = 150

start_end_same = False
label_convertor = dict(
    type='MtlTabNetConvertor',
